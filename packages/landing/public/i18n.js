...
(function () {
  ...
  var EN = {
    ...
    "Nach der Bestellung bekommen Sie sofort eine Rechnung per E-Mail — mit IBAN, Verwendungszweck und QR-Code für Ihre Banking-App. Sie zahlen bequem per Überweisung.": "After ordering you immediately get an invoice by email — with IBAN, payment reference and a QR code for your banking app. You pay conveniently by bank transfer.",
    ...
    "Nach der Bestellung bekommen Sie eine Rechnung per E-Mail (Überweisung mit QR-Code). Alle Tarife sind monatlich und ohne Bindung — jederzeit zum Monatsende kündbar.": "After ordering you get an invoice by email (bank transfer with QR code). All plans are monthly and without commitment — cancellable anytime at the end of the month.",
