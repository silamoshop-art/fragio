...
(function () {
  ...
  function css(brand, position) {
    ...
    return [
      ...
      "@media (max-width:480px){.sb-panel{right:0;bottom:0;top:auto;left:auto;width:100vw;max-width:100vw;height:100vh;max-height:100vh;border-radius:0;}.sb-launcher{" + horiz + ":16px;" + vert + ":16px;}.sb-consent{right:12px;left:12px;" + vert + ":88px;width:auto;max-width:none;}}",
    ].join("");
  }
